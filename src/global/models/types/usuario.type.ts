...
export const listaUsuarioEstado: TUsuarioEstado[] = [
  "habilitado",
  "deshabilitado",
  "eliminado",
];
...
export const listaUsuarioPersonaRol: TUsuarioPersonaRol[] = [
  "moderador",
  "miembro",
];

export type TUsuarioExternoRol = "miembro" | "servicio";
export const listaUsuarioExternoRol: TUsuarioExternoRol[] = [
  "miembro",
  "servicio",
];
